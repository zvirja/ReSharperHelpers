...
{
  [ContextAction(GroupType = typeof(CSharpContextActions), Name = "[ReSharperHelpers] Chop method arguments", Description = "Chops method arguments", Priority = short.MinValue)]
