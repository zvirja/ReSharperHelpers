...
{
  [ContextAction(GroupType = typeof(CSharpContextActions), Name = "[ReSharperHelpers] Assert parameter is not null (or empty) action", Description = "Assert parameter is not null or empty.")]
