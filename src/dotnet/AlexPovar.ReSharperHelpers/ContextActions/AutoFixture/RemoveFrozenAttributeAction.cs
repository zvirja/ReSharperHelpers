...
[ContextAction(GroupType = typeof(CSharpContextActions), Name = "[ReSharperHelpers] Remove Frozen AutoFixture attribute", Description = "Removes Frozen AutoFixture attribute.", Priority = short.MinValue)]
