...
$node = Select-Xml -XPath "/n:package/n:metadata/n:version" .\code\AlexPovar.ReSharperHelpers.nuspec -Namespace $nugetNs
...
$env:APPVEYOR_BUILD_VERSION = $env:BUILD_VERSION