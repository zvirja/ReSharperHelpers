...
{
  [ContextAction(Group = "C#", Name = "[AlexHelpers] Set ItemCanBeNull/ItemNotNull attribute", Description = "Sets ItemCanBeNull/ItemNotNull annotation attribute.")]
  public class ContainerNullabilityGroupAction : IContextAction
  {
    ...
    public IEnumerable<IntentionAction> CreateBulbItems()
    {
      ...
      {
        yield return new ActionWrapper(this.ItemNotNullShortName, "Item not null", this).ToHelpersAnnotateAction(anchor);
      }

      if (this.ItemCanBeNullActionAvailable)
      {
        yield return new ActionWrapper(this.ItemCanBeNullShortName, "Item can be null", this).ToHelpersAnnotateAction(anchor);
      }
    }
